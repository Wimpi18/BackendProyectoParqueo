...
public class Constants {
    ...
    public static final long EXPIRATION_TIME_ACCESS_TOKEN = 1000L * 60 * 60 * 24 * 7; // 7 días
    public static final long EXPIRATION_TIME_REFRESH_TOKEN = 1000L * 60 * 15; // 15 mins
